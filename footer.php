...
<footer class="default-wp-footer">
    <div class="content">
        <div class="container">
            <div><?php echo esc_html_e("Lorem | Esto es un ejemplo de texto | Creado por ","Mercurio") ?> <a href="<?php echo esc_url("http//wordpress.org") ?>"><?php echo esc_attr("WordPress")?></a></div>
        </div>
    </div>
</footer>    
<?php } 
